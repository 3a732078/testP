...
{{--//自動載入modal↓--}}
<form style="margin:0" id="uplop" name="uplop" method="POST" action="/osimage" enctype="multipart/form-data" onsubmit="return autose()">
    @csrf
    @method('POST')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="autose()" class="btn btn-primary" >確定載入</button>
            </div>
        </div>
    </div>
</div>
...
{{--    <title>新增筆記(照片)</title>--}}
{{--    <h1>新增筆記(照片)　<button onclick="addeditor()"><i class="fas fa-plus"></i></button></h1>--}}
